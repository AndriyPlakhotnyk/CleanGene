...
def run_command(args) -> int:
    ...
    if args.resume:
        ...
        if args.skip_trim or args.skip_shovill or args.compress_assembly_outputs or args.compress_annotation_outputs or getattr(args,"cleanup_trimmed_fastq",False): atomic_json(run/"provenance"/"resolved_config.json",cfg)
    else:
