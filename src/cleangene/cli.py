...
def _doctor_config_errors(cfg: dict[str,str]) -> list[str]:
    ...
    nonnegative=("SLURM_MAX_PARALLEL","SLURM_PREPROCESS_MAX_INFLIGHT","SLURM_VALIDATION_MAX_INFLIGHT","SLURM_ARBITRATION_MAX_INFLIGHT","SLURM_GROUP_MAX_INFLIGHT","SLURM_JOB_HEADROOM","SLURM_USER_CPU_LIMIT","SLURM_CPU_HEADROOM","SLURM_POLL_SECONDS","SLURM_CONTROLLER_REPORT_INTERVAL_SECONDS")
